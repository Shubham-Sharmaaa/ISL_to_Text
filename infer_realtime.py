...
# def main():
#     parser = argparse.ArgumentParser(description="Real-time ISL→Text inference from webcam.")
#     parser.add_argument("--model", default="models/isl_svc.joblib", help="Path to trained model")
#     parser.add_argument("--camera", type=int, default=0, help="Camera index")
#     parser.add_argument("--conf-threshold", type=float, default=0.5, help="Min probability to accept prediction")
#     parser.add_argument("--allow", nargs="*", default=None, help="Restrict to subset of labels (optional)")
...
#     last_pred = None
#     stable_count = 0
#     STABLE_N = 7  # frames to confirm a gesture before appending
...
#                     feats = landmarks_to_feature(hand_landmarks.landmark).reshape(1, -1)
#                     probs = None
...
#                     text = f"Pred: {pred_label or '-'} ({pred_conf:.2f})" if pred_label else "Pred: -"
